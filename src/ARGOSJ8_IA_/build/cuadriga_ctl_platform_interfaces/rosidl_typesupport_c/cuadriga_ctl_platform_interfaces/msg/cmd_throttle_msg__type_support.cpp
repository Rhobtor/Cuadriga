...
static const _CmdThrottleMsg_type_support_symbol_names_t _CmdThrottleMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)() {
  return &::cuadriga_ctl_platform_interfaces::msg::rosidl_typesupport_c::CmdThrottleMsg_message_type_support_handle;
}

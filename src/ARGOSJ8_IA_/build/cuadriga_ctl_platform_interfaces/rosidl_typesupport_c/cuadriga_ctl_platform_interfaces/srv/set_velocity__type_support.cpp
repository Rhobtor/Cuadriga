...
static const _SetVelocity_Request_type_support_symbol_names_t _SetVelocity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Request)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::SetVelocity_Request_message_type_support_handle;
}
...
static const _SetVelocity_Response_type_support_symbol_names_t _SetVelocity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity_Response)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::SetVelocity_Response_message_type_support_handle;
}
...
static const _SetVelocity_type_support_symbol_names_t _SetVelocity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, SetVelocity)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::SetVelocity_service_type_support_handle;
}

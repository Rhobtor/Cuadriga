...
static const _GetVelocity_Request_type_support_symbol_names_t _GetVelocity_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Request)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::GetVelocity_Request_message_type_support_handle;
}
...
static const _GetVelocity_Response_type_support_symbol_names_t _GetVelocity_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity_Response)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::GetVelocity_Response_message_type_support_handle;
}
...
static const _GetVelocity_type_support_symbol_names_t _GetVelocity_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, GetVelocity)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::GetVelocity_service_type_support_handle;
}

...
static const _EmergencyStop_Request_type_support_symbol_names_t _EmergencyStop_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Request)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::EmergencyStop_Request_message_type_support_handle;
}
...
static const _EmergencyStop_Response_type_support_symbol_names_t _EmergencyStop_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Response)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::EmergencyStop_Response_message_type_support_handle;
}
...
static const _EmergencyStop_type_support_symbol_names_t _EmergencyStop_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop)() {
  return &::cuadriga_ctl_platform_interfaces::srv::rosidl_typesupport_c::EmergencyStop_service_type_support_handle;
}

...
class Metaclass_SetVelocity(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cuadriga_ctl_platform_interfaces.srv.SetVelocity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cuadriga_ctl_platform_interfaces.srv import _set_velocity
...
class SetVelocity(metaclass=Metaclass_SetVelocity):
    from cuadriga_ctl_platform_interfaces.srv._set_velocity import SetVelocity_Request as Request
    from cuadriga_ctl_platform_interfaces.srv._set_velocity import SetVelocity_Response as Response

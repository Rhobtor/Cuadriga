...
class Metaclass_EmergencyStop_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('cuadriga_ctl_platform_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'cuadriga_ctl_platform_interfaces.srv.EmergencyStop')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from cuadriga_ctl_platform_interfaces.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from cuadriga_ctl_platform_interfaces.srv._emergency_stop import EmergencyStop_Request as Request
    from cuadriga_ctl_platform_interfaces.srv._emergency_stop import EmergencyStop_Response as Response

...
static const _CmdThrottleMsg_type_support_symbol_names_t _CmdThrottleMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)),
  }
};
...
{
  return &::cuadriga_ctl_platform_interfaces::msg::rosidl_typesupport_cpp::CmdThrottleMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cuadriga_ctl_platform_interfaces, msg, CmdThrottleMsg)() {
  return get_message_type_support_handle<cuadriga_ctl_platform_interfaces::msg::CmdThrottleMsg>();
}

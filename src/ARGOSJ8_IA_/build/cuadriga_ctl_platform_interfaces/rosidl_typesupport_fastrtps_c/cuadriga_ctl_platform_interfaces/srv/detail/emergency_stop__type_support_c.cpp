...
#include "cuadriga_ctl_platform_interfaces/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_c.h"
...
#include "cuadriga_ctl_platform_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _EmergencyStop_Request__ros_msg_type = cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cuadriga_ctl_platform_interfaces
size_t get_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request(
  const void * untyped_ros_message,
...
static uint32_t _EmergencyStop_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cuadriga_ctl_platform_interfaces
size_t max_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request;
    is_plain =
      (
...
static size_t _EmergencyStop_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Request)() {
...
using _EmergencyStop_Response__ros_msg_type = cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cuadriga_ctl_platform_interfaces
size_t get_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EmergencyStop_Response__ros_msg_type * ros_message = static_cast<const _EmergencyStop_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cuadriga_ctl_platform_interfaces
size_t max_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response;
    is_plain =
      (
...
static size_t _EmergencyStop_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cuadriga_ctl_platform_interfaces__srv__EmergencyStop_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop_Response)() {
...
// already included above
// #include "cuadriga_ctl_platform_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "cuadriga_ctl_platform_interfaces/srv/emergency_stop.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cuadriga_ctl_platform_interfaces, srv, EmergencyStop)() {

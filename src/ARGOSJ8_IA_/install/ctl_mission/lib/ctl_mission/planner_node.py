...
from cuadriga_ctl_mission.planner import *
...
class PlannerNode(Node):
    def __init__(self):
        ...
        self.path_subscriber = self.create_subscription(Path,'/cuadriga/path_planner',self.path_planner_callback,10)
        self.odom_subscriber = self.create_subscription(Odometry,'/cuadriga/odometry/filtered',self.odom_callback,10)
        self.trajectory_visual_publisher = self.create_publisher(Path,'/cuadriga/trajectory_visual',10)
        self.trajectory_publisher = self.create_publisher(JointTrajectory,'/cuadriga/trajectory',10)

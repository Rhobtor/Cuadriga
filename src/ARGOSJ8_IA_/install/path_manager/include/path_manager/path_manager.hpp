 ...
 *
 * Este paquete expone un nodo llamado típicamente `path_manager_node` (namespace `cuadriga`)
 ...
 *
 * Parámetros (nombres típicos, ver `cuadriga_setup/config/cuadriga_params.yaml`):

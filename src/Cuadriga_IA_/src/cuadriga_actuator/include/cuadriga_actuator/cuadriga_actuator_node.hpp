...
private:
  ...
  std::array<int, 2> computeDrivePwms(double linear_velocity, double angular_velocity) const;
  ...
  std::string command_mapping_name_{"twist_channels"};
  std::string serial_port_;
  OutputMode output_mode_{OutputMode::Serial};
  CommandMapping command_mapping_{CommandMapping::TwistChannels};
  ...
  bool invert_turn_direction_{false};
  bool send_angular_first_{false};

...
def generate_launch_description():
    ...
    #Nodo FixPosition
        FixPosition = Node(
            ...
            parameters=[{
                ...
                "customer_input.speed_topic": "/Cuadriga/fixposition/speed"  
                }]
            )
    ...
    # Nodo serial_bridge
        ...
        set_configure = ExecuteProcess(
            cmd=['ros2', 'lifecycle', 'set', 'Cuadriga/serial_bridge', 'configure'],
            output='screen'
        )
        ...
        set_activate = ExecuteProcess(
            cmd=['ros2', 'lifecycle', 'set', 'Cuadriga/serial_bridge', 'activate'],
            output='screen'
        )
